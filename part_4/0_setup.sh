...
init_scripts () {
    ...
    echo "# This file is automatically generated" >> $SCRIPT_3_REMOTE
}
...
install_mcperf () {
    ...
    for nodetype in "memcached" "client-agent" "client-measure"; do
        ...
        if [[ $nodetype == "memcached" ]]; then
            ...
            echo "gcloud compute scp ./scheduler_logger.py ubuntu@$machine:. --ssh-key-file ~/.ssh/cloud-computing --zone europe-west3-a" >> $SCRIPT_3
